            ...
            <table class="table table-hover table-light table-striped" id="dataTable">
                <thead class="table-dark" id="dataTable">
                    <tr>
                        ...
                        <th scope="col">Data Perencanaan</th>
                        <th scope="col">Code Produksi</th>
                ...
                <tbody>
                    @forelse ($realisasi as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('produksi.detail', $data->ProduksiRoti->id) }}" class="btn btn-sm btn-dark">Link Halaman Perencanaan</a>
                            </td>
                            <td>{{ $data->ProduksiRoti->nama_roti }}</td>
                            <td>{{ $data->ProduksiRoti->kode_produksi }}</td>
